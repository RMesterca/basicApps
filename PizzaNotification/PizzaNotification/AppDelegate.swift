...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setCategories () {
        ...
        let pizzaCategory = UNNotificationCategory(identifier: "pizza.step.category", actions: [nextStepAction, stopAction, textInputAction], intentIdentifiers: [], options: [])
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "PizzaNotification")
